...
class _CounselingFormQ6State extends State<CounselingFormQ6> {
  ...
  final TextEditingController familyOpeningUpController =
      TextEditingController();
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  final data = {
                    ...
                    'difficultyUnderstandingLessons':
                        false, // Add state variable if needed

                    // VI. Family
                    'cannotAcceptParentsSeparation':
                        false, // Add state variable if needed
                    'hardTimeWithParentsExpectations':
                        false, // Add state variable if needed
                    'frequentArgumentsWithFamily':
                        false, // Add state variable if needed
                    'familyFinancialConcerns':
                        false, // Add state variable if needed
                    'familyGenderPreference': familyGenderPreference,
                    'familyMemberIllness': familyMemberIllness,
                    'difficultyOpeningUpToFamily':
                        familyOpeningUpController.text,
